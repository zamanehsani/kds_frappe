  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.message === "Logged In") {
        ...
        // Frappe returns 401 with a message on bad credentials
        const msg = data.message || data._server_messages || "Invalid email or password.";
        // _server_messages is a JSON-encoded array of HTML strings — strip tags for display
        const clean =
          typeof msg === "string"
